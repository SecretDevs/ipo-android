...
import kotlinx.android.synthetic.main.item_deal_favorite.view.*
import kotlinx.android.synthetic.main.item_deal_favorite.view.item_deal_date
import kotlinx.android.synthetic.main.item_deal_favorite.view.item_deal_description
import kotlinx.android.synthetic.main.item_deal_favorite.view.item_deal_favorite_btn
import kotlinx.android.synthetic.main.item_deal_favorite.view.item_deal_name
import kotlinx.android.synthetic.main.item_deal_favorite.view.item_deal_risk_value
import kotlinx.android.synthetic.main.item_deal_favorite.view.item_deal_state

class FavoriteDealViewHolder(
    ...
    override fun bindData(data: Deal) {
        this.deal = data
        root.item_deal_number.text = root.resources.getString(R.string.text_deal_number, data.id)
